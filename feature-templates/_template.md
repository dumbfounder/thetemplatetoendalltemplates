...
- keep the whole template self-contained in one markdown file when possible

## Appendix (Optional)
- embed source links, research notes, examples, or migration notes here instead of using sidecar files by default
